...
### Histograms
#### Unit interval
```{r,fig01, fig.height = 6, fig.width = 8, echo=FALSE,  fig.align = "center", warning=FALSE, error=FALSE, message=FALSE}
library(ggplot2)
...
```{r,fig02, fig.height = 6, fig.width = 8, echo=FALSE,  fig.align = "center", warning=FALSE, error=FALSE, message=FALSE}
