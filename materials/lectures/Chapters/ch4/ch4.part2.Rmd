...
library(tidyverse)
Ammonium<- c(rep(0:5, each=3))
Strength<- c(1221, 1207, 1187, 1555 , 1562 , 1575, 1827, 1839, 1802, 1609, 1627, 1642, 1451, 1472, 1465, 1321, 1289, 1292 )
df<- data.frame(Ammonium, Strength)
df %>% ggplot(aes(Ammonium, Strength))+ geom_point(color= "blue")+theme(panel.background = element_rect(fill = "lightgray", colour = "#6D9EC1", size = 2, linetype = "solid"))
...
Strength<- c(1221, 1207, 1187, 1555 , 1562 , 1575, 1827, 1839, 1802, 1609, 1627, 1642, 1451, 1472, 1465, 1321, 1289, 1292 )
df<- data.frame(Ammonium, Strength)
df %>% ggplot(aes(Ammonium, Strength))+ geom_point(color= "blue")+theme(panel.background = element_rect(fill = "lightgray", colour = "#6D9EC1", size = 2, linetype = "solid"))+ geom_smooth(method = "lm", se=FALSE)+
...
```{r, warning=FALSE,message=FALSE, fig.height= 4 , fig.width= 7, fig.align='center', error=FALSE, echo= FALSE}
my.formula <- y ~ I(x)+ I(x^2)+I(x^3)
Ammonium<- c(rep(0:5, each=3))
Strength<- c(1221, 1207, 1187, 1555 , 1562 , 1575, 1827, 1839, 1802, 1609, 1627, 1642, 1451, 1472, 1465, 1321, 1289, 1292 )
df<- data.frame(Ammonium, Strength)
df %>% ggplot(aes(Ammonium, Strength))+ geom_point(color= "blue")+theme(panel.background = element_rect(fill = "lightgray", colour = "#6D9EC1", size = 2, linetype = "solid"))+ geom_smooth(method = "lm",  se=FALSE, formula=y ~ poly(x, 3, raw=TRUE),colour="red")+
   stat_poly_eq(formula = my.formula,
                eq.with.lhs = "italic(hat(y))~`=`~",
                aes(label = paste(..eq.label.., sep = "~~~")), 
                parse = TRUE)
...
<img src="figure/alloy-residuals-plot-001.png" alt="alloy" width="300", height= "350">
