...
Grader \dotfill Li, Yusi (yusi1409@iastate.edu, help hours tba) \\
...
\begin{center} \begin{minipage}{6.5in}
\begin{flushleft}
First Exam \textit{(tentative)} \dotfill October 3, Thursday \\
Fall break \dotfill Monday - Friday, November 25-29\\
Drop Deadline \dotfill November 1, Friday\\
Second Exam  \textit{(tentative)} \dotfill November 7, Thursday\\
Course Final  \textit{(TBA)} \dotfill Final exam weeks, December 16-19\\
\end{flushleft}
\end{minipage}
\end{center}
\vskip.25in
...
\begin{flushleft}
\textbf{Exams:} 
There will be two semester exams and a comprehensive final. The semester exams will be given during the lecture period and will be closed book. The final exam is comprehensive, and the exat date and time will be announced soon.
\end{flushleft}
\end{minipage}
\end{center}
