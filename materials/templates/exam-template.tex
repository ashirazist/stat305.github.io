...
\begin{coverpages}
   ...
   \fbox{\fbox{\parbox{5.5in}{
      ...
      \vspace{.25cm} 
      \begin{itemize}
         \item  The exam is scheduled for $if(time.length)$$time.length$$else$80 minutes$endif$, from $if(time.start)$$time.start$$else$3:40$endif$ to $if(time.stop)$$time.stop$$else$5:00 PM$endif$. At $if(time.stop)$ $time.stop$ $else$ 5:00 PM $endif$ the exam will end.\\
