...
\vspace{3cm}
\newpage
\part[3] Using this fitted multivariate linear relationship, what do we suppose the salary would be for an engineer with a undergraduate GPA of 2.82 living in a location with a median income of 30.68 thousand dollars?

\hfill \fbox{ \textcolor[rgb]{1.00,1.00,1.00}{$\bigcap$} \hskip -0.4cm $\hat y =$ \hspace{10cm}}
\vspace{3cm}
\part[3] The actual salary of one engineer surveyed with a undergraduate GPA of 2.82 living in a location with a median income of \$30,680 was \$72,460.  What is the residual for this specific engineer's actual salary using the fitted multivariate linear relationship? 
\hfill \fbox{ \textcolor[rgb]{1.00,1.00,1.00}{$\bigcap$} \hskip -0.4cm $\text e =$ \hspace{2cm}}
\vspace{4cm}
\part[3] For the linear relationship, find \(r\), the sample correlation coeffecient and \(R^2\), the coeffecient of determination.
...
\vspace{3cm}
\part[2] For your response for \(R^2\) in previous part, provide an interpretation.\vspace{3cm}
...
\begin{itemize}
\item System 1: 0.86, 0.81, 0.79, 0.77, 0.78, 0.82, 0.78, 0.84, 0.88, 0.77 (with $\bar{x_1} = 0.81, s_1^2 = 0.0015$)
\item System 2: 0.79, 0.83, 0.81, 0.73, 0.74, 0.72, 0.81, 0.81, 0.81, 0.78 (with $\bar{x_2} = 0.78, s_2^2 = 0.0015$)
\end{itemize}

\emph{Note: there are 10 sample data of each system. i.e $n_1= n_2= 10$}
\vspace{.3cm} \qparts{
\part[3] Provide a 95\% confidence interval for the mean proportion of obstacles avoided on the course using System 1.
\hfill \fbox{ \textcolor[rgb]{1.00,1.00,1.00}{$\bigcap$} \hskip -0.4cm $(\hspace{3cm},\hspace{3cm} )$ }
\vspace{4cm}
\part[3] Provide a one-sided 95\% lower bound confidence interval for the mean proportion of obstacles avoided on the course using System 2. 
\hfill \fbox{ \textcolor[rgb]{1.00,1.00,1.00}{$\bigcap$} \hskip -0.4cm $(\hspace{3cm},\hspace{3cm} )$ }
\vspace{3cm}
\newpage
\part[3] Assuming that the proportion of obstacles avoided is roughly normally distributed and that the both systems have the same variance in proportion of obstacles avoided, conduct a hypothesis test at the $\alpha = 0.05$ significance level for the claim that the true mean of the obstackes avoided of the two systems are significantly different.\\
\emph{Note: Write down all six steps for full credit.}
 \vspace{4cm} 
}
...
Seventy independent messages are sent from an electronic transmission
center. Messages are processed sequentially, one after another.
Transmission time of each message is Exponential with parameter
\(\alpha = 5\)min.\\
\qparts{
