...
\begin{center}
<<fig.width=5, fig.height=5, out.width='.5\\linewidth', echo=FALSE, message=FALSE, warning= FALSE>>=
  library(ggplot2)
  p<-qplot(weight,failure_time,xlab="Weight Exceeding Guidelines (in tonnes)",ylab="Travel Distance to Failure (10,000 miles)") + coord_fixed(.05)
   p
@
\end{center}
...
\begin{enumerate}
      ...
      \begin{align*}
         b_1 &= \frac{ \sum_{i = 1}^n x_i y_i - n \bar{x} \bar{y} }{ \sum_{i = 1}^n x_i^2 - n \bar{x}^2 } \\
             ...
             &= \Sexpr{ ( (1444) - (50) * (64/50) * (1558/50) )/( 107 - 50 * (65/50)^2 ) } \\
      \end{align*} 
      and with $b_1$ we can find the value fo $b_0$: 
      \begin{align*}
         b_0 &= \bar{y} - b_1 \bar{x} \\
             &= (1558/50) - (\Sexpr{ ( (1444) - (50) * (64/50) * (1558/50) )/( 107 - 50 * (65/50)^2 ) }) (64/50) \\
             &= \Sexpr{(1558/50) - ( ( (1444) -  (50) * (64/50) * (1558/50) )/( 107 - 50 * (65/50)^2 ) )* (64/50) } \\
      \end{align*} 
      ...
      \item Find and interpret the value of $R^2$ for the fitted linear relationship.[5 pts]\\
            ...
            r &= \frac{\sum_{i=1}^n x_i y_i - n \bar{x} \bar{y}}{\sqrt{\left(\sum_{i=1}^n x_i^2 - n \bar{x}^2\right)\left(\sum_{i=1}^n y_i^2 - n\bar{y}^2\right)}} \\
              ...
              &= \Sexpr{ ( (1444) - (50) * (64/50) * (1558/50) )/(sqrt( (107 - 50 * (64/50)^2 ) *(61528 - (50) * (1558/50)^2 ))) } \\
            \end{align*} 
            So $R^2 = (r)^2 = \Sexpr{( ( (1444) - (50) * (64/50) * (1558/50) )/(sqrt( (107 - 50 * (64/50)^2 ) *(61528 - (50) * (1558/50)^2 ))) )^2}$\\
      ...
      \item Using the fitted line, provide a predicted value of travel distance to failure when the weight exceeding the guidelines is 3.4 tonnes.[5 pts]\\
         $$ \hat{y} = 62.47 - 24.46(3.4) = \Sexpr{62.47 - 24.46*(3.4)} $$
