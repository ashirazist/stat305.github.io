...
The first bulb lasted 521.4 hours, the second bulb lasted 501.2 hours, 
...
There are three environments available to them ( RV, a basement, and a laboratory) and two precursors (Chemical compound) (pseudoephedrine/methylamine). They are both willing to try all their options in order to get the best results.
...
Jessie also tries a new environment, South America.
...
-  Methods of measurements are available for some physical properties (length, mass, temperature, ...) 
  -  Often, the behavior of anengineering system can be adequately characterized in terms of such properties
...
<center>
   <h2> If You Can't Measure, You Can't Do Statistics </h2>
   <img src="figs/funny1.JPG" alt="dmc logo" height="200"> 
   <img src="figs/funny2.JPG" alt="dmc logo" height="200">
      <img src="figs/funny3.JPG" alt="dmc logo" height="200"> 
</center>
]
---
layout:false
...
-  **Validity**: appropriately represent the feature of interest
    ...
    -  Some of it is due to the fact that the measurement processes have their own inherent variablity.
]
---
layout:false
.left-column[
...
A measurement system is called **precise** if it produces small variation in repreated measurement of the same object
...
<center>
   <h2></h2>
   <img src="figs/shooting.JPG" alt="dmc logo" height="250" width= "300"> 
...
\\[
h  = h_0 + v_h \cdot t - \frac{1}{2} g t^2, \text{ } t \ge 0,
\\]
where 
...
<center>
   <h2></h2>
   <img src="figs/projectile.png" alt="dmc logo" height="200"> 
